	...
	public function fetchOrdersData()
	{
		...
		foreach ($data as $key => $value) {
			...
			if(in_array('updateOrder', $this->permission)) {
				$buttons .= ' <a href="'.base_url('Controller_Orders/update/'.$value['id']).'" class="btn btn-default btn-sm"><i class="fa fa-pencil"></i> Edit</a>';
			}
	...
	*/
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
            ...
            // false case
        	$salesman = $this->model_salesman->getSalesmanData(1);
        	$this->data['company_data'] = $salesman;
        	$this->data['is_vat_enabled'] = ($salesman['vat_charge_value'] > 0) ? true : false;
        	$this->data['is_service_enabled'] = ($salesman['service_charge_value'] > 0) ? true : false;
	...
	*/
	public function printDiv($id)
	{
		...
		if($id) {
			...
			$salesman_info = $this->model_salesman->getSalesmanData(1);
