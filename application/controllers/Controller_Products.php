    ...
    */
	public function fetchProductData()
	{
		...
		foreach ($data as $key => $value) {
            ...
            $suppliers_data = $this->model_suppliers->getSuppliersData($value['suppliers_id']);
			// button
            $buttons = '';
            if(in_array('updateProduct', $this->permission)) {
    			$buttons .= '<a href="'.base_url('Controller_Products/update/'.$value['id']).'" class="btn btn-default btn-sm"><i class="fa fa-pencil"></i> Edit</a>';
            }
	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	$data = array(
                ...
                'suppliers_id' => $this->input->post('suppliers'),
