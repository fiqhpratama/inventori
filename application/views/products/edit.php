        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="store">Suppliers</label>
                  <select class="form-control select_group" id="suppliers" name="suppliers">
                    <?php foreach ($suppliers as $k => $v): ?>
                      <option value="<?php echo $v['id'] ?>" <?php if($product_data['suppliers_id'] == $v['id']) { echo "selected='selected'"; } ?> ><?php echo $v['supplier_name'] ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
