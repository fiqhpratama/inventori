                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Suppliers</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createSuppliers" <?php if($serialize_permission) {
                          if(in_array('createSuppliers', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateSuppliers" <?php if($serialize_permission) {
                          if(in_array('updateSuppliers', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewSuppliers" <?php if($serialize_permission) {
                          if(in_array('viewSuppliers', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteSuppliers" <?php if($serialize_permission) {
                          if(in_array('deleteSuppliers', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <tr>
                        <td>Elements</td>
